                                            ...
                                            <div id="smartwizard2" class="forms-wizard-alt sw-main sw-theme-default">
                                                <ul class="forms-wizard nav nav-tabs step-anchor">
                                                    <li class="nav-item active">
                                                            <em>2</em><span>Configuration du bot</span>
                                                    </li>
                                                </ul>
                                                <div class="form-wizard-content sw-container tab-content" style="min-height: 200.333px;">
                                                    ...
                                                    <center>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <option value="08">0.8.x</option>
							<option selected="selected" value="010">0.10.x (Recommandé)</option>
							<option value="012">0.12.x</option>
                                    ...
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span>128MB RAM</span></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-3 widget-content bg-premium-dark">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                             <div class="widget-numbers text-warning"><span>20% de 1 coeur</span></div>
                                        </div>
                                    </div>
                                </div>
